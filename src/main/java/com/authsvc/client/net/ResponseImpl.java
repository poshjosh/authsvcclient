...
/**
 * @author Chinomso Bassey Ikwuagwu on Jan 9, 2019 11:27:30 AM
 */
public class ResponseImpl implements Response{
    ...
    public ResponseImpl(URLConnection urlConn) throws IOException {
        ...
        this.cookies = this.loadCookiesFromResponse(urlConn);
        LOG.fine(() -> "Loaded cookies from response: " + this.cookies);            
    }
    
    public List<String> loadCookiesFromResponse(URLConnection urlConn) { 
