 ...
 * @since    2.0
 */
public class AuthSvcSession extends RemoteSession {
    
    public AuthSvcSession() { }

    public AuthSvcSession(String target) {
        super(target);
    }

    public AuthSvcSession(String target, int maxRetrials, long retrialInterval) {
